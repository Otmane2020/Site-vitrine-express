#!/usr/bin/env node
/**
 * Script pour initialiser les tables dans Supabase PostgreSQL
...
const client = new Client({
  host: 'db.lwvdqvsgwirzbtvfqovz.supabase.co',
  port: 5432,
  database: 'postgres',
  user: 'postgres',
  password: process.env.SUPABASE_SERVICE_ROLE_KEY?.split('.')[0] || 'your-password',
...
(async () => {
  try {
    ...
    console.log('🎉 Base de données Supabase initialisée!');
